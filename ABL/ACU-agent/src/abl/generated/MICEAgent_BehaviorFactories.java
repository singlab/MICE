   ...
   static public Behavior behaviorFactory0(int __$behaviorID, Object[] __$args, Map __$boundVars, GoalStep __$parentGoal, String __$signature, BehavingEntity __$thisEntity, __BehaviorDesc __$behaviorDesc) {
      switch (__$behaviorID) {
         case 0: {
            ...
            final __StepDesc[] __$steps = {new __StepDesc(0, MICEAgent.__$stepFactory0_rfield), new __StepDesc(1, MICEAgent.__$stepFactory0_rfield)};
         ...
         case 1: {
            // startEventThread_1
               ...
               __$behaviorFrame[0] = ((ObjectWrapper)__$boundVars.get("test")).objectValue();

            final __StepDesc[] __$steps = {new __StepDesc(2, MICEAgent.__$stepFactory0_rfield), new __StepDesc(3, MICEAgent.__$stepFactory0_rfield)};
